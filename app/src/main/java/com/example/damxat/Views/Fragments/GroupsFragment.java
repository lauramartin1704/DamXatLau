...
public class GroupsFragment extends Fragment {
    ...
    public void showDialog(){
        ...
        btnSaveList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Tenemos una referencia a la instancia de la base de datos de firebase, creamos una nueva instancia de grupo
                // Finalmente guardamos el grupo por la referencia en firebase
    ...
    public void refreshRecycler(){
        ...
        //Aquí estamos agregando un Listener a la referencia para que sepamos cuándo cambia sus datos.
        ref.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                arrayGroups.clear();
                //Aquí vamos por cada item que tiene el grupo y lo agregamos a nuestra lista de grupos.
